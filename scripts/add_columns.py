...
targetpath = '../data/06-08-2022/tag78_50m_increment_long_beach_test_457049_0.csv'
sourcepath = None
...
if 'latitude' in hydrophone_data.columns and 'longitude' in hydrophone_data.columns:
    ...
    sensor_x, sensor_y = utils.to_cartesian((latitudes, longitudes), tag_coords)
    ...
    hydrophone_data['tag_bearing'] = utils.angle_between(compass_vecs, (sensor_x, sensor_y))
...
# Add speed calculated from the GPS coordinates
